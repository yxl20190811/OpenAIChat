...
// OpenAIChatDlg.cpp: 实现文件
//

#include "pch.h"
#include "framework.h"
#include "OpenAIChat.h"
#include "OpenAIChatDlg.h"
...
COpenAIChatDlg::COpenAIChatDlg(CWnd* pParent /*=nullptr*/)
	: CDialogEx(IDD_OPENAICHAT_DIALOG, pParent)
{
...
// COpenAIChatDlg 消息处理程序

BOOL COpenAIChatDlg::OnInitDialog()
{
...
void COpenAIChatDlg::OnSysCommand(UINT nID, LPARAM lParam)
{
...
//显示。
HCURSOR COpenAIChatDlg::OnQueryDragIcon()
{
